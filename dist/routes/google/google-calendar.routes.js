...
const auth2Client = new googleapis_1.google.auth.OAuth2(
/// client ID, CLIENT SECRET, REDIRECTURL
// ENV VARIALBES
"2790401802-39c3m188lv8frhkjopi8qt7699elects.apps.googleusercontent.com", "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", "http://localhost:4500/api/v1/google/redirect");
...
router.get("/schedule_event", async (req, res) => {
    const result = await calendar.events.insert({
        ...
        requestBody: {
            ...
            start: {
                dateTime: (0, dayjs_1.default)(new Date()).add(1, "day").toISOString(),
                timeZone: "America/El_Salvador",
            },
            end: {
                dateTime: (0, dayjs_1.default)(new Date()).add(2, "day").toISOString(),
                timeZone: "America/El_Salvador",
            },
        },
    });
